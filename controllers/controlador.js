...
carroControlador.calcularIPVA = function (req,res){
    try {
        res.render("calcular")
    } catch (error) {
        res.status(500).send("Erro ao acessar página da calculadora  " + error);
    }
}


carroControlador.calcularIPVA_feito= function(req,res){
